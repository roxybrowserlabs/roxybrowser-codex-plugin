...
This plugin is the publishable Codex package for RoxyBrowser. It does not implement a new MCP server. It wraps the existing public RoxyBrowser MCP packages for Codex:
